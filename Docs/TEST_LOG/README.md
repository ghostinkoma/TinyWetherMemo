...
| [WetherLoggerBox_2026-09-13.md](WetherLoggerBox_2026-09-13.md) | CH32V003 24/48MHz書込(minichlink初成功)+クロックA/B(消費+1.8mA=48MHz採用)、雷センサ感度スイープ+スパーク試験(内燃遮蔽ライター=ノイズ分類/クロック非依存)、旧ESP32 LDO破損が真因と確定、**★WiFi断でも雷ログが残る実証**(CH32一次バッファ+FS永続=WiFi非依存) の実測ログ |
